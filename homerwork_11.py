...
r.add_phone('+380503539526')
r.add_phone('+380503539527')
r.edit_phone('+380503539527','+380503539528')
r1.add_phone('+380504539526')
r1.add_phone('+380504539527')
r3.add_phone('+380504878526')


#print(type(Phone('+380503539526')))
print(r.name.value)
for p in r.phones:
    print(p.value)

a = AddressBook("Work telephones")
b = Birthday('30.03.1977')
#b.value='30.03.1977'
r.add_birthday(b)
